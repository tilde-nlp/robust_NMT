...
LV_PHONETIC_MAPPING = dict(zip([l for l in "āčēģīķļņšūž" + "āčēģīķļņšūž".upper()],
                               ["aa", "ch", "ee", "gj", "ii", "kj", "lj", "nj", "sh", "uu", "zh"] + [r.capitalize() for
                                                                                                     r in
                                                                                                     ["aa", "ch", "ee",
                                                                                                      "gj", "ii", "kj",
                                                                                                      "lj", "nj", "sh",
...
noiseFunctions = [(latinize, "<0>"), (phoneticLatinize, "<1>"), (addDiacritic, "<2>"), (deleteLetters, "<3>"),
                  (permuteLetters, "<4>"), (introduceExtraLetters, "<5>"), (confuseLetters, "<6>"),
                  (spell.sampleSubstitute, "<7>"), (removePunctuation, "<8>")]
